...
pane_xpath: str = '//div[@id="pane-side"]'
qr_xpath: str = '//*[contains(@aria-label, "QR code")]'
loading_xpath: str = '//div[@data-testid="wa-web-loading-screen"]'

BASE_PP_XPATH: str = f'//span[@title="{STATUS_UPLOADER_NAME}"]/ancestor::*[@role="row"]' # To identify specfied user
profile_picture_status_xpath: str = BASE_PP_XPATH + '//*[@data-testid="status-new-indication"]' # Green circle
...
# play_btn_xpath: str =  '//*[@aria-label="Play"]' # play button icon # NOT USED
pause_btn_xpath: str = '//*[@aria-label="Pause"]' # pause button icon # test this

# All bars(each statuses) of the status not the container(irrespective if viewed or not)
bars_xpath: str = '//*[contains(@aria-label, "Go to status")]'
...
img_status_xpath: str = '(//*[@data-testid="status-player-uie"]//img[contains(@style, "visibility: visible")])[last()]'
...
search_field_xpath: str = '//input[@placeholder="Search or start a new chat"]'
unviewed_status_xpath: str = '//div[contains(@class, "x5fxwdf")]'
status_exit_xpath: str = '//*[@aria-label="Close"]'
